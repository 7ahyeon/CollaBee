...
<body>
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            <img src="resources/imgs/신상품홍보이미지/신상품홍보이미지.png" style="width: 100%">
        </div>
        <div class="col-sm-2"></div>
    </div>

    <h4 class="text-center" style="margin: 50px 0px;"> <카테고리명> </h4>
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            ...
            <div id="category-box">
                <ul>
                    <li><a href="#" class="sub-category-opt">전체보기</a></li>
                    <li><a href="#" class="sub-category-opt">친환경</a></li>
                    <li><a href="#" class="sub-category-opt">고구마・감자・당근</a></li>
                    <li><a href="#" class="sub-category-opt">시금치・쌈채소・나물</a></li>
                    <li><a href="#" class="sub-category-opt">브로콜리・파프리카・양배추</a></li>
                    <li><a href="#" class="sub-category-opt">양파・대파・마늘・배추</a></li>
                    <li><a href="#" class="sub-category-opt">오이・호박・고추</a></li>
                    <li><a href="#" class="sub-category-opt">냉동・이색・간편채소</a></li>
                    <li><a href="#" class="sub-category-opt">콩나물・버섯</a></li>
                </ul>
            </div>
