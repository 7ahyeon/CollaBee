    ...
    <div class="col-sm-6">
        ...
        <br>
            <form id="form" name="form" method="post">
                쿠폰번호 <input class="form-control form-control" name="couponNum" value="${vo.couponNum}" disabled/>
                <br>
                쿠폰명 <input class="form-control form-control" name="couponName" value="${vo.couponName}" disabled/>
                <br>
                할인금액 <input class="form-control form-control" name="disPrice" value="${vo.disPrice}" disabled/>
                <br>
                수량 <input class="form-control form-control" name="count" value="${vo.count}" disabled/>
                <br>
                유효기간 <input class="form-control form-control" name="couponDate" value="${vo.couponDate}" disabled/>
                <br>
                최소 구매금액 <input class="form-control form-control" name="leastCost" value="${vo.leastCost}" disabled/>
                <br>  
            </form>
