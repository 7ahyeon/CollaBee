    ...
    <div class="container-fluid">
      ...
      <div class="row" style="margin-bottom: 50px;">
        ...
        <div class="col-sm-6">
          ...
          <div>
            <table class="table">
              ...
              <tr>
                ...
                <td>
                  <textarea class="form-control" rows="18" id="comment" name="text" placeholder="답변 내용을 입력하세요."></textarea>
                </td>        
              </tr>
          ...
          <div>    
            <button class="answer_btn" type="button" style="width: 120; height: 44; border-radius: 3;">등록</button>
          </div>
          </div>
              </div>
              </div>
