          ...
          <div style="width: 800px;">
            ...
            <br>
              <form id="form" name="form" method="post">
                  ...
                  <br>
                  상품명 <input type="text" class="form-control form-control" name="productName" value="${goods.productName}" autofocus/>
                  <br>
                  상품정보 <input type="text" class="form-control form-control" name="pDescription" value="${goods.pDescription}"/>
                  <br>
                  상품가격 <input type="text" class="form-control form-control" name="price" value="${goods.price}"/>
                  <br>
                  할인율 <input type="text" class="form-control form-control" name="disRate" value="${goods.disRate}"/>
                  <br>
                  할인가격 <input type="text" class="form-control form-control" name="saleprice" value="${goods.saleprice}"/>
                  <br>
                  할인기간 <input type="date" class="form-control form-control" name="disDate"/>
                  <br>
                  포장타입 <input type="text" class="form-control form-control" name="condition" value="${goods.condition}"/>
                  <br>
                  배송유형 <input type="text" class="form-control form-control" name="deliveryType" value="${goods.deliveryType}"/>
                  <br>
                  입고수량 <input type="text" class="form-control form-control" name="stock" value="${goods.stock}"/>
                  <br>
