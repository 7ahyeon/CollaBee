          ...
          <div style="width: 800px;">
            ...
            <br>
              <form id="form" name="form" method="post">
                  상품번호 <input class="form-control form-control" name="productNum" style="border: none;" value="${goods.productNum}"/>
                  <br>
                  상품명 <input type="text" class="form-control form-control" name="productName" disabled/>
                  <br>
                  상품설명 <input type="text" class="form-control form-control" name="pDescription" disabled/>
                  <br>
                  상품가격 <input type="text" class="form-control form-control" name="price" disabled/>
                  <br>
                  할인율 <input type="text" class="form-control form-control" name="disRate" disabled/>
                  <br>
                  할인가격 <input type="text" class="form-control form-control" name="saleprice" disabled/>
                  <br>
                  할인기간 <input type="date" class="form-control form-control" name="disDate" disabled/>
                  <br>
                  입고수량 <input type="text" class="form-control form-control" name="stock" disabled/>
                  <br>
                  포장타입
	              <br>  
			        <form>
